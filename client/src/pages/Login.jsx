...
import { FiLock, FiUser, FiEye, FiEyeOff, FiLogIn, FiUserCheck } from "react-icons/fi";
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-3">
              <button
                ...
                disabled={isLoading || isDemoLoading}
                className="w-full bg-[#2a4a6a] hover:bg-[#3a5a7a] active:bg-[#4a6a8a] text-white font-['Segoe_UI','Arial',sans-serif] font-medium py-2.5 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 border border-[#4a9aff]/30"
              >
                {isDemoLoading ? (
                  <>
                    <svg className="animate-spin h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  ...
                  <>
                    ...
                    <span>Sign in Using Demo Account</span>
                  </>
                )}
              </button>
              <p className="text-[8px] text-[#4a5a6a] text-center mt-2 font-['Segoe_UI','Arial',sans-serif]">
